...
describe("JoiPasswordComplexity", () => {
        ...
        describe("minOfUppercase", () => {
                const schema = (value) => joiPassword.string().minOfUppercase(2).validate(value);
        ...
        describe("minOfLowercase", () => {
                const schema = (value) => joiPassword.string().minOfLowercase(2).validate(value);
        ...
        describe("minOfSpecialCharacters", () => {
                const schema = (value) => joiPassword.string().minOfSpecialCharacters(2).validate(value);
        ...
        describe("minOfNumeric", () => {
                const schema = (value) => joiPassword.string().minOfNumeric(2).validate(value);
        ...
        describe("noWhiteSpaces", () => {
                const schema = (value) => joiPassword.string().noWhiteSpaces().validate(value);
